...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :session_timeout, :activity_logging, :brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    user.email_delivery_method = Rails.env.production? ? :deliver_later : :deliver_now
    ...
    # Default: `5 * 60`
    #
    user.reset_password_time_between_emails = Rails.env.development? ? nil : 300
